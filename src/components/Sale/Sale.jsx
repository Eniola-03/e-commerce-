      ...
      <div className="container pt-3">
        <nav style={{"--bs-breadcrumb-divider" : '>'}} aria-label="breadcrumb">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active" aria-current="page">Sale</li>
          </ol>
        </nav>
      </div>
    </section>
        ...
        <div className="main pt-5">
          ...
          <div className="sectiontwo">
            <div className="heading">
                <h2>Sale</h2>
                <p>You cant keep up with it. So, our natural desire to wear fashionable clothes has many reasons such as historical, social and others. Therefore being fashionable costs alot of money. But nowadays fashion is not such unavailble as it was a couple of centuries ago. It wil suit you best of all. Because we all live in the time of total consuming of uncountable goods and services, and this has become the main reason for rapid growth of a so-called culture of consumption in our society. So, this circumstance forced all leading successful companies to explore all needs and wishes of different groups of potential clients deeply. We are lucky to have an opportunity to buy qualitative, fashionable and affordable clothes. Our employees put in great effort to make this commodity. </p>
            </div>
